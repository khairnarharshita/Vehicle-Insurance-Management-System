...
<form method="post">
  <input type="submit" id="ok-button"name="approve" value="Approve">
  <input type="submit" id="ok-button"name="disapprove" value="Disapprove">
</form>
</div>
...
if (isset($_POST['approve'])) {
  ...
  $sql = "UPDATE claim SET claim_Status = 'Approved' WHERE claim_id = '$claim_no'";
  $results = mysqli_query($db, $sql);
  header("Location: admin_claim.php");


} elseif (isset($_POST['disapprove'])) {
  // Update claim status to D
  $sql = "UPDATE claim SET claim_Status = 'Disapproved' WHERE claim_id = '$claim_no'";
  $results = mysqli_query($db, $sql);
  header("Location: admin_claim.php");
