...
<form action="admin_claim.php" method="post">
<div class="form-row">
    <div class="form-group col-md-6">
    <label for="">Claim number</label>
    <input type="text" class="form-control" name ="claim_no" require>
  </div>
 <?php
    
	if (isset($_POST['claim_no'])) {
		$claim_no = $_POST['claim_no'];
		$url = "update_claim.php?claim_no=" . $claim_no;
		header('Location: ' . $url);
		exit() ;
	}
...
<br>
<button type="submit" class="btn"id="ok-button"name="payment">update</button>
